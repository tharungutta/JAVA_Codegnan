...
public class Single_main {
 public static void main(String[] args) {
	...
	m2.display();
	m2.calculateSalary();                             // The object will call the non parameterized of sub class , the sub class will call the non parameterized of                                                   // super class. sub class only call the non- parameterized
}
}
